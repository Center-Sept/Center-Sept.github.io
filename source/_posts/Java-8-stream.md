...
categories: []
---
## <a href="#Java-8-stream" class="headerlink" title="Java 8 stream"></a>Java 8 stream

### <a href="#流的创建" class="headerlink" title="流的创建"></a>流的创建
...
Stream<Integer> stream2 = Stream.iterate(0
...
```java
Stream<Integer> stream = Stream.of(6
...
## <a href="#list转map方法" class="headerlink" title="list转map方法"></a>list转map方法
...
```java
Map<Boolean, List<Person>> children = Stream.generate(new
limit(100
collect(Collectors.partitioningBy(p -> p.getAge() < 18
System.out.println("Children number: "
System.out.println("Adult number: "
```
